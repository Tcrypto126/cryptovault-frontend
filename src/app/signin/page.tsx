...
const SignIn = () => {
  ...
  return (
    <>
      <div className="w-full h-screen flex justify-center items-center bg-[url('/assets/signin/sign-bg.webp')] bg-cover bg-center bg-no-repeat">
        <div className="w-full max-w-[1440px] flex gap-20 justify-center px-24">
          ...
          <div className="flex-1 max-w-[500px] flex flex-col gap-10 p-12 bg-[#ffffff1e] rounded-2xl">
