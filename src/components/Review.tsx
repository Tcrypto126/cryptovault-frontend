      ...
      <div className="w-full max-w-[421px] h-full p-6 rounded-[12px] border-border border-[1px] bg-[#FAFAFA08] space-y-2">
        <div className="flex gap-3 items-center">
          ...
          <div className="flex flex-col">
            <h5 className="font-bold">Fabrizio Fernandez</h5>
            <h6 className="text-text">@fab3304</h6>
          </div>
        </div>
        <div>
          <p className="text-text text-[16px]">
            Testing out <span className="text-[#A78BFA]">@launchui</span>&apos;
            responsive design. That’s the template we’ve all been waiting for.
